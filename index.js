...
let users=[];
const app=express();
//app.use(express.json());երբ json ինֆորմացիա է գալիս parse է անում
...
});//serializeUser-օբյեկտից ստանում ենք տեքստը կամ id
passport.deserializeUser((id,done)=>{
done(null,users.find((user)=>user.id===id));
});//deserializeUser-տեքստից կամ id-ից ստանում ենք օբյեկտ
